...
@section("link")
	...
	<!-- iCheck 1.0.1 -->
	<script src="/Public/plugins/iCheck/icheck.min.js"></script>
	<script src="/Public/js/organ/addOrgan.js"></script>
@endsection
	...
	<div class="box-body">
		<form role="form-horizontal" id="info_form" novalidate="novalidate">
			<table class="table table-bordered">
				<tbody>
				<tr>
					<td class="title" colspan="6"><i class="fa fa fa-info-circle"></i> 添加企业信息</td>
				</tr>
				<tr class="form-group">
					<th class="col-md-2"><span class="text-red">*</span> 企业全称</th>
					<td class="col-md-4">
						<div class="form-group"><input type="text" class="form-control" id="componyName"
													   name="organ_name" placeholder="企业全称"></div>
					</td>
					<th class="col-md-2"><span class="text-red">*</span> 企业简称</th>
					<td class="col-md-4">
						<div class="form-group"><input type="text" class="form-control" id="componySimName"
													   name="organ_short_name" placeholder="企业简称"></div>
					</td>
				...
				<tr class="form-group">
					...
					<td class="col-md-4">
						<div class="form-group"><input type="text" class="form-control" id="contact_person"
													   name="contact_person" placeholder="联系人"></div>
					</td>
					<th class="col-md-2">联系电话</th>
					<td class="col-md-4">
						<div class="form-group"><input type="text" class="form-control" id="connect_tel"
													   name="contact_phone" placeholder="联系电话"></div>
					</td>
					<th class="col-md-2">联系邮箱</th>
					<td class="col-md-4">
						<div class="form-group"><input type="text" class="form-control" id="connect_mail"
													   name="contact_email" placeholder="联系邮箱"></div>
					</td>
				</tr>
				<tr class="form-group">
				...
				<tr class="form-group">
					<th class="col-md-2"><span class="text-red">*</span> channel_id</th>
					<td class="col-md-4">
						<div class="form-group"><input type="text" class="form-control" id="SDK_ID" name="channel_id"
													   placeholder=""></div>
					</td>
					<th class="col-md-2">channel_secret</th>
					<td class="col-md-4">
						<div class="form-group"><input type="text" class="form-control" id="SDK_psd"
													   name="channel_secret" placeholder=""></div>
					</td>
				</tr>
				<tr class="form-group">
					<th>企业备注</th>
					<td colspan="6">
						<div class="form-group"><textarea class="form-control" id="comp_mark" name="comment"
														  placeholder="输入企业备注信息"></textarea></div>
					</td>
				</tr>
