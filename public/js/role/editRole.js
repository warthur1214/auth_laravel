...
$(function() {
    ...
    var $organId = $('#belonged_organ_id'); //企业或者机构id
    ...
    function initRoleInfo(){
        ...
        AjaxJson('/Home/Role/getInfoById/id/' + _id, function( res ){  
            ...
            initRoleAuthorization( res.belonged_organ_id ); 

            $('#belonged_organ_id').val( $('#roleTree [data-id="'+ res.belonged_organ_id +'"] > .tree-node').text() );
